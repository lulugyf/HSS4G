...
public class TASServlet  extends MyBaseServlet{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String rbody = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                ...
                "<MessageID xmlns=\"http://www.chinamobile.com/IMS/VoLTEAS/\">1</MessageID></SOAP-ENV:Header><SOAP-ENV:Body>" +
                "<m:"+op+"Response xmlns:m=\"http://www.chinamobile.com/IMS/VoLTEAS/\"><m:Result>" +
                "<m:ResultCode>0</m:ResultCode><m:ResultDesc>操作成功。</m:ResultDesc></m:Result></m:"+op+"Response>" +
                "</SOAP-ENV:Body></SOAP-ENV:Envelope>]";
