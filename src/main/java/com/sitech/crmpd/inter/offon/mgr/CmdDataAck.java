...
public class CmdDataAck extends BasePkt {
	...
	public void varsPut(Map<String, String> vars) {
		vars.put("phoneNo", this.phone_no);
		vars.put("imsi",    this.imsi_no);
		vars.put("ssInfo1", this.ss_info1);
		vars.put("ssInfo2", this.ss_info2);
		vars.put("ssInfo3", this.ss_info3);
	}
